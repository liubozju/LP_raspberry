...
TARGET              += mqtt-example  mqtt-example_tsl mqtt-example_robot mqtt_rrpc-example mqtt_multi_thread-example
SRCS_mqtt-example   := mqtt/mqtt-example.c
SRCS_mqtt-example_tsl   := mqtt/mqtt-example_tsl.c
SRCS_mqtt-example_tsl   += mqtt/sensor_dht11.c
SRCS_mqtt-example_robot   := mqtt/mqtt-example_robot.c
SRCS_mqtt-example_robot   += mqtt/sensor_dht11.c
