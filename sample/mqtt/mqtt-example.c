...
#define ALINK_TOPIC_EVENT_PUB     	 "/sys/"PRODUCT_KEY"/"DEVICE_NAME"/thing/event/Alarm/post"
    ...
    #define DEVICE_SECRET           "7T20pmh6X7dMxtR3aoE8glmoahadfJma"
    ...
    #define DEVICE_SECRET           "7T20pmh6X7dMxtR3aoE8glmoahadfJma"
#else
/*    #define PRODUCT_KEY             "a1Q9PP17SGy"//
    #define DEVICE_NAME             "test"
    #define DEVICE_SECRET           "R306102Ua9aPdVv03YPlsdtAn4QOSaLs"
*/
//    #define PRODUCT_KEY             "a1eAzw8oWqy"
//    #define DEVICE_SECRET           "H0aHAUVcM8BhpkCwPZTdI4pAivxiee8N"
//    #define DEVICE_NAME             "test"

    #define DEVICE_SECRET           "yOXDcxeEuxwab9rvLq46iPaLbcHBdzo7"
    #define DEVICE_NAME             "test"
    #define PRODUCT_KEY             "a1sSaFfonkv"
#endif
...
//	printf("humidity = %d temperature = %d\r\n",humidity,temperature);
        msg_len = snprintf(msg_pub, sizeof(msg_pub), "{\"state\":{\"reported\":{\"temperature\":\"%f\", \"humidity\":\"%f\"}}}", temperature,humidity);
        if (msg_len < 0) {
